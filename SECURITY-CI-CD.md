...
Security workflow implementation tracked in:
- **Epic**: `hq-23` - Security CI/CD Automation Epic
- **Tasks**:
  - `hq-20` - Implement GitHub Actions security workflow
  - `hq-21` - Verify security workflow blocks non-compliant PRs
  - `hq-22` - Document security CI/CD workflow
